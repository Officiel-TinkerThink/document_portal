...
class DocumentHandler:
    ...
    def save_pdf(self, uploaded_file):
        try:
            ...
            if not filename.lower().endswith(".pdf"):
                raise DocumentPortalException("Invalid file type. Only PDF is supported.")
    ...
    def read_pdf(self, pdf_path):
        try:
            ...
            self.log.info("PDF read succesfully", pdf_path=pdf_path, session_id=self.session_id, pages=len(text_chunks))
            return text
        except Exception as e:
...
if __name__ == "__main__":
    ...
    pdf_path = r"\\data\\document_analysis\\NIPS-2017-attention-is-all-you-need-Paper.pdf"
